...
class ShippingQuoteDetailsScreen extends GetView<ShippingQuoteDetailsController> {
  ShippingQuoteDetailsScreen({super.key,
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextWidget1(
                            textTitle: 'Pick Up Date',
                            style: CustomTheme.shippingText1,
                          ),
                          TextWidget1(
                            textTitle: '20/08/2023',
                            style: CustomTheme.shippingText2,
                          ),
                        ],
                      ),
