...
class OnboardingScreen2 extends GetView<OnboardScreenController> {
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    ...
                    Get.offAndToNamed(kLoginScreen);
                  },
                  child: TextWidget(
                    textTitle: 'Skip',
          ...
          Row(
            children: [
              TextWidget1(
                textTitle: 'the best shipping is guaranteed\nwith moyenxpress because are\nexpert in it.',
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(ImageUtils.onboard2),
          fit: BoxFit.fill,
        ),
      ),
    );
